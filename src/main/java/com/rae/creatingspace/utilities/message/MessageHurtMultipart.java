package com.rae.creatingspace.utilities.message;

import com.rae.creatingspace.CreatingSpace;
import com.rae.creatingspace.server.entities.IHurtableMultipart;
    ...
    public static class Handler {
        ...
        public static void handle(MessageHurtMultipart message, Supplier<NetworkEvent.Context> context) {
            ...
            if (context.get().getDirection().getReceptionSide() == LogicalSide.CLIENT) {
                player = CreatingSpace.PROXY.getClientSidePlayer();
            }
