package com.rae.creatingspace.client.renderer.entity.Sandstorm.Model;
...
public class ModelSandstorm<T extends LivingEntity> extends AdvancedEntityModel<T> {
    ...
    public ModelSandstorm(int type) {
        texWidth = 128;
        texHeight = 128;
        this.type = type;
    ...
    public void setupAnim(LivingEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if(type == 0){
            ...
            if(entity instanceof EntitySandstormBody){
                float offset = (float) ((((EntitySandstormBody)entity).getBodyIndex() + 1 ) * Math.PI * 0.5F);
