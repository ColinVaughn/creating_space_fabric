...
public abstract class CustomDimensionEffects extends DimensionSpecialEffects {
    ...
    public static class GenericCelestialOrbitEffect extends CustomDimensionEffects {
        ...
        public GenericCelestialOrbitEffect(ResourceLocation bodyTexture) {
        ...
        public boolean renderSky(ClientLevel level, int ticks, float partialTick, PoseStack poseStack, Camera camera, Matrix4f projectionMatrix, boolean isFoggy, Runnable setupFog) {
            ...
            poseStack.mulPose(Axis.XP.rotationDegrees(camera.getEntity().level().getTimeOfDay(partialTick) * 360.0F));
        ...
        protected void renderAdditionalBodyEffects(PoseStack poseStack, Camera camera, ResourceLocation bodyTexture) {
            ...
            poseStack.pushPose();
            poseStack.mulPose(Axis.YP.rotationDegrees(-90.0F));
            poseStack.mulPose(Axis.XP.rotationDegrees(camera.getEntity().level().getTimeOfDay(6000) * 360.0F + 180.0F));  // Add 180 degrees for opposite side
